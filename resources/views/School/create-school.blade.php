                        ...
                        <form id="createSchoolForm">
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="example-email">Email (optional)</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" class="form-control" rows="3" placeholder="School address"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="registration_date" value="{{ now()->format('Y-m-d') }}" readonly>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            $('#createSchoolForm').on('submit', function (e) {
                ...
                // Only validate required fields (school_type and name)
                var requiredFields = ['school_type', 'name'];
