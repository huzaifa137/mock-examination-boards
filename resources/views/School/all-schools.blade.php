                        ...
                        <tbody>
                            ...
                            @forelse ($schools as $key => $school)
                                <tr>
                                    ...
                                    <td class="fw-bold" style="text-align: left;">{{ $school->name }}</td>
                                    <td class="fw-bold" style="text-align: left;">{{ $school->name }}</td>
                                    <td class="fw-bold" style="text-align: left;">{{ $school->registration_code }}</td>
                                    <td>
                                        @php
                                            $status = $statusConfig[$school->school_status ?? 10] ?? [
                                                'label' => 'Active',
                                                'class' => 'text-success',
                                                'icon' => 'fas fa-check-circle',
                                            ];
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                ...
                                                data-id="{{ $school->id }}" data-status="{{ $school->school_status ?? 10 }}"
